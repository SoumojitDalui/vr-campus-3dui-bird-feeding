...
class ONSPPropagation
{
    ...
    {
        // Assignment 2 does not use Oculus propagation geometry. Returning a no-op
        // interface avoids unnecessary native audio plugin initialization paths,
        // including FMOD-related warnings from unused backends.
        return new NullPropagationInterface();
    }
    ...
    public class NullPropagationInterface : PropagationInterface
    {
        public int SetPropagationQuality(float quality) { return 0; }
        public int SetPropagationThreadAffinity(UInt64 cpuMask) { return 0; }
        public int CreateAudioGeometry(out IntPtr geometry) { geometry = IntPtr.Zero; return 0; }
        public int DestroyAudioGeometry(IntPtr geometry) { return 0; }
        public int AudioGeometryUploadMeshArrays(IntPtr geometry, float[] vertices, int vertexCount, int[] indices, int indexCount, MeshGroup[] groups, int groupCount) { return 0; }
        public int AudioGeometrySetTransform(IntPtr geometry, float[] matrix4x4) { return 0; }
        public int AudioGeometryGetTransform(IntPtr geometry, out float[] matrix4x4) { matrix4x4 = new float[16]; return 0; }
        public int AudioGeometryWriteMeshFile(IntPtr geometry, string filePath) { return 0; }
        public int AudioGeometryReadMeshFile(IntPtr geometry, string filePath) { return 0; }
        public int AudioGeometryWriteMeshFileObj(IntPtr geometry, string filePath) { return 0; }
        public int AudioMaterialGetFrequency(IntPtr material, MaterialProperty property, float frequency, out float value) { value = 0f; return 0; }
        public int CreateAudioMaterial(out IntPtr material) { material = IntPtr.Zero; return 0; }
        public int DestroyAudioMaterial(IntPtr material) { return 0; }
        public int AudioMaterialSetFrequency(IntPtr material, MaterialProperty property, float frequency, float value) { return 0; }
        public int AudioMaterialReset(IntPtr material, MaterialProperty property) { return 0; }
    }
